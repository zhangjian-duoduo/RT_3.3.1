...
*            GROUP号
*
*       [in] const FH_VPU_MASK_V2 *pstVpumaskinfo
*            隐私屏蔽属性
*
*   Return:
*           0(成功)
...
*          各平台支持功能有所差异,详见《视频函数开发参考手册》。
*/
FH_SINT32 FH_VPSS_SetMaskV2(FH_UINT32 grpidx,const FH_VPU_MASK_V2 *pstVpumaskinfo);

/*
*   Name: FH_VPSS_GetMaskV2
*            获取视频处理模块隐私屏蔽属性
*
*   Parameters:
*
...
*            GROUP号
*
*       [out] FH_VPU_MASK_V2 *pstVpumaskinfo
*            隐私屏蔽属性
*
*   Return:
*           0(成功)
...
*          各平台支持功能有所差异,详见《视频函数开发参考手册》。
*/
FH_SINT32 FH_VPSS_GetMaskV2(FH_UINT32 grpidx,FH_VPU_MASK_V2 *pstVpumaskinfo);
...
*          非0(失败，详见错误码)
*   Note:
*          此接口仅适用于FH8652&FH8656&FH8658系列产品,仅通道3支持。
*          FH8652&FH8656&FH8658系列: sel: 0->LDC之后 1->PM之后 2->Gosd之后
*/
...
*          非0(失败，详见错误码)
*   Note:
*          此接口适用于FH8652&FH8656&FH8658系列产品,仅通道3支持。
*          此接口适用于FH8852V201系列＆FH8626V200产品,仅通道2支持。
*          需要在FH_VPSS_CreateGrp后调用。
*/
