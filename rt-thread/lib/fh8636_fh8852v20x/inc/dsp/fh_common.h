...
#define FH8626V200                           (0x8626A200)
#define FH8898                               (0x8898A100)
#define FH8896                               (0x8896A100)
#define FH8210                               (0x8210A100)
#define FH8862                               (0x8862A100)
#define FH8856V300                           (0x8856A300)
#define FH8858V300                           (0x8858A300)
#define FH8852V310                           (0x8852A310)
#define FH8856V310                           (0x8856A310)
#define FH8858V310                           (0x8858A310)
...
typedef enum
{
	...
	VPU_VOMODE_10BIT_BLK    = 18, // blk 10bit(专用格式) | [ ]
	VPU_VOMODE_8BIT_BLK     = 19, // blk 8bit(专用格式)| [ ]
	VPU_VOMODE_BUTT            ,
