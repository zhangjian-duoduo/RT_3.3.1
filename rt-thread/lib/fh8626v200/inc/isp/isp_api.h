...
*            ISP的设备号
*
*       [IN]  const ISP_VI_HW_ATTR *pstViHwAttr
*            结构体ISP_VI_HW_ATTR的指针
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       无
*/
FH_SINT32 FUNC_DEP API_ISP_SetViHwAttr(FH_UINT32 u32IspDevId, const ISP_VI_HW_ATTR *pstViHwAttr);
/*
...
*       无
*/
FH_SINT32 FUNC_DEP API_ISP_DetectPicSize(FH_UINT32 u32IspDevId);
/*
*   Name: API_ISP_Run
*            ISP策略处理
*
...
*       无
*/
FH_SINT32 API_ISP_GetRaw(FH_UINT32 u32IspDevId, FH_VOID* pRawBuff, FH_UINT32 u32Size, FH_UINT32 u32FrameCnt);
/*
