...
{
    FH_UINT8 u08Dark2LightInttSpeed;   // 小图阶段由暗至亮曝光时间阶段调整速度 | [0x0-0xff]
    FH_UINT8 u08Dark2LightGainSpeed;   // 小图阶段由暗至亮增益阶段调整速度 | [0x0-0xff]
    FH_UINT8 u08light2DarkInttSpeed;    // 小图阶段由亮至暗曝光时间阶段调整速度 | [0x0-0xff]
    FH_UINT8 u08light2DarkGainSpeed;    // 小图阶段由亮至暗增益阶段调整速度 | [0x0-0xff]
} AE_INIT_CFG;
