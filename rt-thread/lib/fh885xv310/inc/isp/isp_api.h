...
*       不支持
*/
FH_SINT32 FUNC_DEP API_ISP_GetBuffSizeIspOut(FH_UINT32 u32IspDevId, ISP_MEM_INIT* stMemInit);
/*
...
/*
*   Name: API_ISP_CLEAN_CIRCLUAR_BUFF
*            清空循环缓冲
*
*   Parameters:
*
...
*       无
*/
FH_SINT32 FUNC_DEP API_ISP_CLEAN_CIRCLUAR_BUFF(FH_UINT32 u32IspDevId);
/*
*   Name: API_ISP_Pause
*            暂停ISP对图像的处理与输出
*
...
*       无
*/
FH_SINT32 FUNC_DEP API_ISP_SoftReset(FH_UINT32 u32IspDevId);
/*
*   Name: API_ISP_Resume
*            恢复ISP对图像处理与输出
*
...
*            ISP的设备号
*
*       [IN]  ISP_DUMP_RAW_BUF *dumpRawBuf
*            类型为ISP_DUMP_RAW_BUF的结构体指针，详细成员变量请查看ISP_DUMP_RAW_BUF结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       应用层需申请足够的vmm内存
*/
FH_SINT32 API_ISP_SetDumpRawBuf(FH_UINT32 u32IspDevId, ISP_DUMP_RAW_BUF *dumpRawBuf);
/*
*   Name: API_ISP_GetDumpRawPost
*            ISP节点导出raw功能Post, 配置相关信息
*
*   Parameters:
*
*       [IN]  FH_UINT32 u32IspDevId
...
*       应用层需申请足够的vmm内存
*/
FH_SINT32 API_ISP_GetDumpRawPost(FH_UINT32 u32IspDevId, ISP_DUMP_RAW_BUF *dumpRawBuf);
/*
*   Name: API_ISP_GetDumpRawCfg
*            ISP节点导出raw功能配置支持
*
*   Parameters:
*
...
*       应用层需申请足够的vmm内存
*/
FH_SINT32 API_ISP_GetDumpRawCfg(FH_UINT32 u32IspDevId, ISP_DUMP_RAW_BUF *dumpRawBuf);
/*
*   Name: API_ISP_GetCoefRawCfg
*            导出Coef raw功能配置支持
*
*   Parameters:
*
...
*            ISP的设备号
*
*       [IN]  ISP_COEF_RAW_CFG *coefRawCfg
*            类型为ISP_COEF_RAW_CFG的结构体指针，详细成员变量请查看ISP_COEF_RAW_CFG结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       应用层需申请足够的vmm内存
*/
FH_SINT32 API_ISP_GetCoefRawCfg(FH_UINT32 u32IspDevId, ISP_COEF_RAW_CFG *coefRawCfg);
/*
*   Name: API_ISP_GetCoefRaw
*            导出Coef raw功能
*
*   Parameters:
*
...
*            ISP的设备号
*
*       [IN] ISP_AF_FILTER_V2 *pstAfFilter
*            类型为ISP_AF_FILTER2的结构体指针，详细成员变量请查看ISP_AF_FILTER结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       不支持FH885XV300
*/
FH_SINT32 API_ISP_SetAFFilter_V2(FH_UINT32 u32IspDevId, ISP_AF_FILTER_V2 *pstAfFilter);
/*
*   Name: API_ISP_GetAFFilter_V2
*            获取af滤波器参数。
*
*   Parameters:
*
...
*            ISP的设备号
*
*       [OUT] ISP_AF_FILTER_V2 *pstAfFilter
*            类型为ISP_AF_FILTER2的结构体指针，详细成员变量请查看ISP_AF_FILTER结构体定义。
*
*   Return:
*            0(正确)
...
*       不支持FH885XV300
*/
FH_SINT32 API_ISP_GetAFFilter_V2(FH_UINT32 u32IspDevId, ISP_AF_FILTER_V2 *pstAfFilter);
/**BLC*/
/*
...
*            ISP的设备号
*
*       [IN] STATIC_DPC_CFG *pstStaticDpc
*            类型为STATIC_DPC_CFG的结构体指针，详细成员变量请查看ISP_DPC_CFG结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       无
*/
FH_SINT32 API_ISP_SetStaticDpc(FH_UINT32 u32IspDevId, STATIC_DPC_CFG *pstStaticDpc);
/*
...
*            ISP的设备号
*
*       [IN] const ISP_AF_STAT_CFG_V2 *pstAfStatCfg
*            类型为ISP_AF_STAT_CFG的2结构体指针，详细成员变量请查看ISP_AF_STAT_CFG结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
*   Note:
*       1. 统计窗的大小参数输入范围为0-512，实际生效的统计窗的大小为2-512
*       2. 统计窗的大小和偏移都只支持偶数，输入非偶数时API会自动校正为偶数
*       3. 不支持FH885XV300
*/
FH_SINT32 API_ISP_SetAFStatCfg_V2(FH_UINT32 u32IspDevId, const ISP_AF_STAT_CFG_V2 *pstAfStatCfg);
/*
*   Name: API_ISP_GetAFStatCfg_V2
*            获取af统计配置相关参数。
*
*   Parameters:
*
...
*            ISP的设备号
*
*       [OUT] const ISP_AF_STAT_CFG_V2 *pstAfStatCfg
*            类型为ISP_AF_STAT_CFG2的结构体指针，详细成员变量请查看ISP_AF_STAT_CFG结构体定义。
*
*   Return:
*            0(正确)
*            非0(失败，详见错误码)
...
*       不支持FH885XV300
*/
FH_SINT32 API_ISP_GetAFStatCfg_V2(FH_UINT32 u32IspDevId, ISP_AF_STAT_CFG_V2 *pstAfStatCfg);
/*
...
*       不支持
*/
FH_SINT32 FUNC_DEP API_ISP_GetGroupAwbAdvStat(FH_UINT8 u8GrpId, GROUP_AWB_ADV_STAT *pstGroupAwbAdvStat);
/*
...
*       不支持
*/
FH_SINT32 FUNC_DEP API_ISP_GetGroupHistStat(FH_UINT8 u8GrpId, GROUP_HIST_STAT *pstGroupHistStat);
/**DBG**/
/*
