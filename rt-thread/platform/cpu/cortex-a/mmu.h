...
#define SECT_RWX_NORNCNB (PGD_SECT_S|SECT_AP_RW|(PGD_SECT_TEX(1))|PGD_DOMAIN(0)| PGD_TYPE_SECT)
...
#define SECT_RWNX_NCNB_NORMAL  (PGD_SECT_TEX(1)|SECT_AP_RW|PGD_DOMAIN(0)|PGD_TYPE_SECT|PGD_SECT_XN)
...
struct mem_desc
{
    ...
    unsigned int sect_attr;   /* when page mapped */
    unsigned int page_attr;   /* only sector mapped valid */
    unsigned int mapped_mode;
