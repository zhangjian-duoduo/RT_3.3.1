...
#ifndef __FH8858V310_IOPAD_H__
#define __FH8858V310_IOPAD_H__
...
PINCTRL_FUNC(SD1_CD, 10, FUNC3, PUPD_NONE, 3);
...
PINCTRL_FUNC(PWM2, 18, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO45, 18, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(PWM3, 19, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO46, 19, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_RMII_CLK, 20, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO48, 20, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_CLK, 20, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM2, 20, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_H_0, 20, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_REF_CLK, 21, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_TXD_0, 22, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO49, 22, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_CD, 22, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM3, 22, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_H_1, 22, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_TXD_1, 23, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO50, 23, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_CMD_RSP, 23, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM4, 23, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_H_2, 23, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_TXEN, 24, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO51, 24, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_0, 24, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM5, 24, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_H_3, 24, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_RXD_0, 25, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO52, 25, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_1, 25, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM6, 25, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_V_0, 25, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_RXD_1, 26, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO53, 26, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_2, 26, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM7, 26, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_V_1, 26, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_RXDV, 27, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO54, 27, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_3, 27, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(PWM8, 27, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_V_2, 27, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_MDC, 28, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO55, 28, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(PWM9, 28, FUNC3, PUPD_NONE, 3);
PINCTRL_FUNC(STM_V_3, 28, FUNC4, PUPD_NONE, 3);
PINCTRL_FUNC(MAC_MDIO, 29, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO56, 29, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_CLK, 30, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO57, 30, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(I2C1_SCL, 30, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_CD, 31, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO58, 31, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(I2C1_SDA, 31, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_CMD_RSP, 32, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO59, 32, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(UART1_TX, 32, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_0, 33, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO60, 33, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(UART1_RX, 33, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_1, 34, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO61, 34, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(UART2_TX, 34, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_2, 35, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO62, 35, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(UART2_RX, 35, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD1_DATA_3, 36, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO63, 36, FUNC1, PUPD_NONE, 3);
...
PINCTRL_FUNC(SD1_CD, 41, FUNC4, PUPD_NONE, 3);
...
PINCTRL_FUNC(SSI1_CLK, 48, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO11, 48, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SSI2_CLK, 48, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SSI1_CSN_0, 49, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO14, 49, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SSI2_CSN_0, 49, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SSI1_TXD, 50, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO15, 50, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SSI2_TXD, 50, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SSI1_RXD, 51, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO16, 51, FUNC1, PUPD_NONE, 3);
PINCTRL_FUNC(SSI2_RXD, 51, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(SD0_CD, 52, FUNC0, PUPD_NONE, 3);
...
PINCTRL_FUNC(SADC_XAIN2, 61, FUNC0, PUPD_NONE, 2);
PINCTRL_FUNC(GPIO24, 61, FUNC1, PUPD_NONE, 2);
PINCTRL_FUNC(SADC_XAIN3, 62, FUNC0, PUPD_NONE, 2);
PINCTRL_FUNC(GPIO25, 62, FUNC1, PUPD_NONE, 2);
...
PINCTRL_FUNC(SD1_CD, 63, FUNC5, PUPD_NONE, 3);
...
PINCTRL_FUNC(MIPI_DP2, 71, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO33, 71, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(MIPI_DN2, 72, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO34, 72, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(MIPI_DP3, 73, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO35, 73, FUNC2, PUPD_NONE, 3);
PINCTRL_FUNC(MIPI_DN3, 74, FUNC0, PUPD_NONE, 3);
PINCTRL_FUNC(GPIO36, 74, FUNC2, PUPD_NONE, 3);
...
PINCTRL_MUX(I2C1_SCL, 1, &PAD11_I2C1_SCL, &PAD30_I2C1_SCL, &PAD46_I2C1_SCL);
PINCTRL_MUX(I2C1_SDA, 1, &PAD12_I2C1_SDA, &PAD31_I2C1_SDA, &PAD47_I2C1_SDA);
...
PINCTRL_MUX(MIPI_DN2, 0, &PAD72_MIPI_DN2);
PINCTRL_MUX(MIPI_DN3, 0, &PAD74_MIPI_DN3);
PINCTRL_MUX(MIPI_DP0, 0, &PAD67_MIPI_DP0);
PINCTRL_MUX(MIPI_DP1, 0, &PAD69_MIPI_DP1);
PINCTRL_MUX(MIPI_DP2, 0, &PAD71_MIPI_DP2);
PINCTRL_MUX(MIPI_DP3, 0, &PAD73_MIPI_DP3);
...
PINCTRL_MUX(STM_H_0, 0, &PAD11_STM_H_0, &PAD20_STM_H_0);
PINCTRL_MUX(STM_H_1, 0, &PAD12_STM_H_1, &PAD22_STM_H_1);
PINCTRL_MUX(STM_H_2, 0, &PAD13_STM_H_2, &PAD23_STM_H_2);
PINCTRL_MUX(STM_H_3, 0, &PAD14_STM_H_3, &PAD24_STM_H_3);
PINCTRL_MUX(STM_V_0, 1, &PAD25_STM_V_0, &PAD37_STM_V_0);
PINCTRL_MUX(STM_V_1, 1, &PAD26_STM_V_1, &PAD38_STM_V_1);
PINCTRL_MUX(STM_V_2, 1, &PAD27_STM_V_2, &PAD39_STM_V_2);
PINCTRL_MUX(STM_V_3, 1, &PAD28_STM_V_3, &PAD40_STM_V_3);
...
PINCTRL_MUX(GPIO33, 0, &PAD3_GPIO33, &PAD71_GPIO33);
PINCTRL_MUX(GPIO34, 0, &PAD4_GPIO34, &PAD72_GPIO34);
PINCTRL_MUX(GPIO35, 0, &PAD5_GPIO35, &PAD73_GPIO35);
PINCTRL_MUX(GPIO36, 0, &PAD6_GPIO36, &PAD74_GPIO36);
...
PINCTRL_DEVICE(MIPI, 10, &MUX_MIPI_CKN, &MUX_MIPI_CKP, &MUX_MIPI_DN0,
        &MUX_MIPI_DN1, &MUX_MIPI_DN2, &MUX_MIPI_DN3, &MUX_MIPI_DP0,
        &MUX_MIPI_DP1, &MUX_MIPI_DP2, &MUX_MIPI_DP3);
