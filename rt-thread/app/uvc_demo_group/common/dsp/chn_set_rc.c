...
FH_VOID sample_common_set_h264_rc_vbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h264_vbr.init_qp                 = 20;
    cfg->rc_attr.h264_vbr.ImaxQP                  = 40;
    cfg->rc_attr.h264_vbr.IminQP                  = 10;
    cfg->rc_attr.h264_vbr.PmaxQP                  = 40;
    cfg->rc_attr.h264_vbr.PminQP                  = 10;
