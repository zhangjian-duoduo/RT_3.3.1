...
struct nn_channel_info g_nn_channel_info[MAX_GRP_NUM] = {
    {
        ...
        .enable = 1,
        .channel = 0,
#if defined(CH4_BIND_VGS_G0) || defined(CH4_VDEC_BIND_VGS_G0)
        .type = FH_OBJ_VPPU,
#else
        .type = FH_OBJ_VPU_VO,
#endif
...

    {
        ...
        .enable = 1,
        .channel = 1,
#if defined(CH4_BIND_VGS_G1) || defined(CH4_VDEC_BIND_VGS_G1)
        .type = FH_OBJ_VPPU,
#else
        .type = FH_OBJ_VPU_VO,
#endif
...

    {
        ...
        .enable = 1,
        .channel = 2,
#if defined(CH4_BIND_VGS_G2) || defined(CH4_VDEC_BIND_VGS_G2)
        .type = FH_OBJ_VPPU,
#else
        .type = FH_OBJ_VPU_VO,
#endif
    ...
    {
        .enable = 0,
#if defined(NN_ENABLE_G3)
        .enable = 1,
        .channel = 3,
#if defined(CH4_BIND_VGS_G3) || defined(CH4_VDEC_BIND_VGS_G3)
        .type = FH_OBJ_VPPU,
#else
        .type = FH_OBJ_VPU_VO,
#endif
