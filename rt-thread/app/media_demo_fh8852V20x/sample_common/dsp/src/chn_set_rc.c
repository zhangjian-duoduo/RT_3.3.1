...
FH_VOID sample_common_set_h264_rc_fixqp(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h264_fixqp.FrameRate.frame_time  = info->frame_time;
}
...
FH_VOID sample_common_set_h264_rc_avbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h264_avbr.ImaxQP                 = 42;
    cfg->rc_attr.h264_avbr.IminQP                 = 28;
    cfg->rc_attr.h264_avbr.PmaxQP                 = 42;
...
FH_VOID sample_common_set_h264_rc_cvbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h264_cvbr.ImaxQP                 = 42;
    cfg->rc_attr.h264_cvbr.IminQP                 = 28;
    cfg->rc_attr.h264_cvbr.PmaxQP                 = 42;
...
FH_VOID sample_common_set_h264_rc_qvbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h264_qvbr.ImaxQP                 = 42;
    cfg->rc_attr.h264_qvbr.IminQP                 = 28;
    cfg->rc_attr.h264_qvbr.PmaxQP                 = 42;
...
FH_VOID sample_common_set_h265_rc_avbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h265_avbr.ImaxQP                 = 42;
    cfg->rc_attr.h265_avbr.IminQP                 = 28;
    cfg->rc_attr.h265_avbr.PmaxQP                 = 42;
...
FH_VOID sample_common_set_h265_rc_cvbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h265_cvbr.ImaxQP                 = 42;
    cfg->rc_attr.h265_cvbr.IminQP                 = 28;
    cfg->rc_attr.h265_cvbr.PmaxQP                 = 42;
...
FH_VOID sample_common_set_h265_rc_qvbr(struct enc_channel_info *info, FH_VENC_CHN_CONFIG *cfg)
{
    ...
    cfg->rc_attr.h265_qvbr.ImaxQP                 = 42;
    cfg->rc_attr.h265_qvbr.IminQP                 = 28;
    cfg->rc_attr.h265_qvbr.PmaxQP                 = 42;
...
{
    cfg->rc_attr.rc_type                         = FH_RC_MJPEG_CBR;
    cfg->rc_attr.mjpeg_cbr.initqp                = 50;
    cfg->rc_attr.mjpeg_cbr.bitrate               = info->bps;
    cfg->rc_attr.mjpeg_cbr.FrameRate.frame_count = info->frame_count;
    cfg->rc_attr.mjpeg_cbr.FrameRate.frame_time  = info->frame_time;
}
