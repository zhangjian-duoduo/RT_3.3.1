...
static FH_SINT32 g_jpeg_chn = 15;
...
FH_SINT32 sample_common_get_mjpeg_chn(FH_VOID)
{
    return g_jpeg_chn;
}
...
FH_SINT32 sample_common_media_sys_init(FH_VOID)
{
    ...
    WR_PROC_DEV(JPEG_PROC, "allchnstm_0_5000000_32");
    WR_PROC_DEV(JPEG_PROC, "frmsize_15_3000000_3000000");
    WR_PROC_DEV(JPEG_PROC, "jpgstm_5000000_32");
    WR_PROC_DEV(JPEG_PROC, "mjpgstm_5000000_32");
    WR_PROC_DEV(ENC_PROC, "stm_6000000_128");
    WR_PROC_DEV(ENC_PROC, "allchnstm_0_6000000_128");
