...
struct bind_dev_info g_bind_dev_info[MAX_GRP_NUM * MAX_VPU_CHN_NUM] = {
    ...
    {
        .vpu2 = CH3_BIND_TYPE_G0,
        .enc2 = CH3_ENC_BIND_TYPE_G0,
    },
    /*********************G0************************/
    ...
    {
        .vpu2 = CH3_BIND_TYPE_G1,
        .enc2 = CH3_ENC_BIND_TYPE_G1,
    },
    /*********************G1************************/

    {
        .vpu2 = CH0_BIND_TYPE_G2,
        .enc2 = CH0_ENC_BIND_TYPE_G2,
    },

    {
        .vpu2 = CH1_BIND_TYPE_G2,
        .enc2 = CH1_ENC_BIND_TYPE_G2,
    },

    {
        .vpu2 = CH2_BIND_TYPE_G2,
        .enc2 = CH2_ENC_BIND_TYPE_G2,
    },

    {
        .vpu2 = CH3_BIND_TYPE_G2,
        .enc2 = CH3_ENC_BIND_TYPE_G2,
    },
    /*********************G2************************/
};
