...
extern FH_UINT32 sample_isp_get_out_mem_size(FH_UINT32 grpid);
extern FH_UINT32 sample_vicap_get_mem_size(FH_UINT32 grpid);
...
extern FH_SINT32 sample_common_stop_coolview(FH_UINT32 grpid);
