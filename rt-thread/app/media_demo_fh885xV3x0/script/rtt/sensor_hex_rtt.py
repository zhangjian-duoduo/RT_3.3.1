...
def find_sensor_hex(rtconfig_file): #找到.config中sensor对应的hex，并生成hex_name数组
...
if __name__ == '__main__':
    ...
    hex_name = find_sensor_hex(rtconfig_file) #get sensor interface type
    ...
    path_in        = os.path.abspath(os.getcwd() + '/sample_common/isp/src/all_sensor_hex.bin')
    path_out       = os.path.abspath(os.getcwd() + '/sample_common/isp/src/')
