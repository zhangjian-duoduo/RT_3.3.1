...
struct pthread_mutex
{
    ...
    /* NOTE:
     *  this object size does not include module(s)
     *  if module is supported, this object size
     *  must be re-calculated!!!
     */
#define PTHREAD_MTX_SIZE    (44)
    char mtx[PTHREAD_MTX_SIZE];
};
...
#define PTHREAD_SEM_SIZE    (40)
    char lck[PTHREAD_SEM_SIZE];
};
