...
static void _pthread_local_cleanup(_pthread_data_t *ptd)
{
...
/* Note on following note:
 *   to support cancellation point, needs kernel support
 * we must check cancellation at sync point.
 */
/*
