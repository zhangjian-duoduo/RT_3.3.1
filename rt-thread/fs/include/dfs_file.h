...
struct dfs_file_ops
{
    ...
    int (*ftruncate)      (struct dfs_fd *fd, rt_off_t len);
    int (*fhide)          (struct dfs_fd *fd, rt_uint32_t enable);
    rt_off64_t (*lseek64) (struct dfs_fd *fd, rt_off64_t offset);
...
struct dfs_fd
{
    ...
    rt_size64_t size64;               /* Size in bytes */
    rt_off64_t pos64;                /* Current file position */
};
