...
typedef unsigned long long              rt_size64_t;
typedef long long                       rt_off64_t;
...
#define RT_TIMER_CTRL_GET_STATE         0x4             /**< change timer to periodic */
...
/* #define RT_THREAD_CTRL_SUSPEND          0x04   */             /**< Suspend specific thread. */
/* #define RT_THREAD_CTRL_RESUME           0x05   */             /**< Resume specific thread. */
...
#ifdef RT_USING_THREAD_LOCK
    void *lock;
#endif

    rt_uint32_t total_ticks; /*running total ticks */
    rt_uint32_t enter_times; /*running total ticks */
...
#define RT_DEVICE_CTRL_BLKPARTCLEANUP   0x6F            /**< clean block device offset   */
#define RT_DEVICE_CTRL_BLKPARTGET       0x70            /**< GET block device offset   */
...
#define RT_DEVICE_CTRL_MTD_REBOOT       0xff
...
extern void runlog_init(int size);
extern void runlog_add_node(int line, void *pfunc, char *name, char *name2);
extern void runlog_export(void);
extern void runlog_deinit(void);
#define RUNLOG_ADD runlog_add_node
#else
#define RUNLOG_ADD(line, func, name, name2) do{}while (0)
