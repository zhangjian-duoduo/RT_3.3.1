...
#define DW_IC_STATUS_ACTIVITY 0x01
#define DW_IC_STATUS_MASTER_ACTIVITY 0x20
#define DW_IC_STATUS_SLAVE_ACTIVITY 0x40
...
#define DW_IC_ENABLE_ABORT 0x10
...
#define DW_IC_TX_ABRT_NOACK                                      \
    (DW_IC_TX_ABRT_7B_ADDR_NOACK | DW_IC_TX_ABRT_10ADDR1_NOACK | \
     DW_IC_TX_ABRT_10ADDR2_NOACK | DW_IC_TX_ABRT_TXDATA_NOACK |  \
...
int I2C_Abort(struct fh_i2c_obj *i2c_obj);
