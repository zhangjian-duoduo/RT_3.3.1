...
#ifndef __FH_UART_H__
#define __FH_UART_H__
...
struct fh_uart
{
    ...
    int irq;
    int use_dma;
    int dma_rx_handshake;
    int dma_tx_handshake;
};
...
#define UART_CLOCK_FREQ (16666667)  /* 16.66MHZ */

typedef enum enum_uart_baudrate
{
    BAUDRATE_2400   = (((UART_CLOCK_FREQ / 2400) + 8) / 16),
